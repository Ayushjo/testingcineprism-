...
const WorldIndiePage = () => {
  ...
  useEffect(() => {
    const fetchWorldIndieMovies = async () => {
      setIsLoading(true);
      setError(null);
      ...
      try {
        ...
        console.error("Error fetching World indie movies:", err);
      ...
      <section className="relative py-12 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Top {movies.length} World Indie Films
            </h1>
            <p
            ...
            >
              Discovering groundbreaking independent cinema from around the globe
            </p>
          </motion.div>
        </div>
      </section>
