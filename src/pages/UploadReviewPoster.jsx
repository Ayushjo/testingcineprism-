...
export default function UploadPosterPage() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        setUploadMessage(
          result.message || "Review poster uploaded successfully!"
        );
        ...
        setUploadStatus("error");
        setUploadMessage(
          result.message || "Failed to upload review poster. Please try again."
        );
      }
    } catch (error) {
  ...
  const hasPoster = (post) => {
    return post.posterImageId || post.reviewPosterImageUrl;
  };
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-4xl font-bold text-white mb-2">
            Upload Review Poster
          </h1>
          <p className="text-slate-400 text-sm sm:text-base">
            Select a post and upload its review poster image
          </p>
        </div>
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    ...
                    <div>
                      <p className="text-white font-medium mb-2 text-sm sm:text-base">
                        Drop your review poster image here
                      </p>
