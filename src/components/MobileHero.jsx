    ...
    const fetchHeroPosters = async () => {
      try {
        ...
        if (data.latestReviews && Array.isArray(data.latestReviews)) {
          // Filter out specific movies (trim titles to handle extra spaces)
          ...
          const transformedPosters = filteredReviews
            .slice(0, 6)
            .map((review) => ({
              id: review.id,
              image:
                review.reviewPosterImageUrl ||
        ...
        <div className="relative z-10 pt-[4.5rem] sm:pt-[4.5rem] md:pt-[4.5rem] px-4 sm:px-6 md:px-8 flex flex-col min-h-screen justify-center pb-4">
          ...
          >
            ...
            >
              <h1 className="leading-[0.9] tracking-tight mb-6 sm:mb-6 md:mb-8">
                <span
                  className={`block font-light mb-2 sm:mb-3 hero-title-small ${
                ...
                <span
                  className={`block font-bold hero-title-large ${
                    theme === "light"
              ...
              <div className="min-h-[120px] sm:min-h-[140px] md:min-h-[160px] flex items-center justify-center max-w-3xl mx-auto">
                {quotes.length > 0 ? (
                  <motion.div
                  ...
                  >
                    <div className="relative">
                      {/* Opening quote mark */}
                      <span
                        className={`absolute -left-2 sm:-left-4 -top-2 sm:-top-4 text-5xl sm:text-6xl md:text-7xl font-editorial leading-none ${
                      ...
                      <p
                        className={`text-lg sm:text-xl md:text-2xl leading-relaxed font-editorial italic tracking-wide ${
                          theme === "light" ? "text-black/85" : "text-slate-200"
                        }`}
                      ...
                      {/* Closing quote mark */}
                      <span
                        className={`absolute -right-2 sm:-right-4 -bottom-2 sm:-bottom-4 text-5xl sm:text-6xl md:text-7xl font-editorial leading-none ${
                          theme === "light" ? "text-black/20" : "text-white/20"
                        }`}
                      >
                        "
              ...
              <div className="relative overflow-hidden rounded-2xl aspect-[16/9] max-w-4xl mx-auto w-full mb-8">
                  ...
                  {heroPosters.map((poster, index) => (
                    ...
                    >
                      ...
                      <div className="relative z-10 w-full h-full">
                        <div
                          className={`relative w-full h-full rounded-2xl overflow-hidden shadow-2xl border-2 transition-all duration-300 hover:scale-105 hover:shadow-3xl ${
                            theme === "light"
                ...
                <div className="absolute top-4 right-4 z-20">
                  <motion.button
                    whileTap={{ scale: 0.98 }}
                    onClick={() =>
                      navigate(`/post/${heroPosters[currentSlide]?.id}`)
                    }
          ...
          {!isLoading && !error && (
            ...
            >
              ...
              >
                Ready to discover your next favorite film? Explore our carefully
                curated top picks and trending recommendations.
              </motion.p>
