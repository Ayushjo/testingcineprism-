// PostPage.jsx - Updated to use AuthContext
"use client";
                    ...
                    <div className="flex items-center gap-2 text-sm text-slate-300">
                      ...
                      <span
                        className={`px-2 py-1 rounded text-xs ${
                          relatedPost.ratingCategory === "HIGHLY_RECOMMENDED"
                            ? "bg-green-500/20 text-green-400"
                            : relatedPost.ratingCategory === "RECOMMENDED"
                            ? "bg-yellow-500/20 text-yellow-400"
                            : "bg-red-500/20 text-red-400"
                        }`}
                      >
                        {relatedPost.ratingCategory.replace("_", " ")}
                      </span>
                    </div>
                  </div>
                </div>
